...
/** Separate context for the sidebar's `side` prop — provided by Sidebar, not SidebarProvider */
const SidebarSideContext = React.createContext<"left" | "right">("left");

/** Hook to access the sidebar's `side` prop ("left" or "right") */
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[side=left][data-collapsible=offcanvas]:after:left-full group-data-[side=right][data-collapsible=offcanvas]:after:right-full group-data-[collapsible=offcanvas]:hover:bg-sidebar",
