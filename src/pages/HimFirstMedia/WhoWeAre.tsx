        ...
        <div className="w-full max-w-4xl mx-auto text-center">
          <motion.div variants={animFadeUp} initial="hidden" animate="visible">
            ...
            <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-medium">
              {t.himFirstMedia?.whoWeAreTagline || "We're passionate Jesus followers, tech experts, and creative visionaries who live to serve the Lord in everything we do."}
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full max-w-4xl mx-auto">
          <motion.div variants={animFadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed font-medium mb-8">
              {t.himFirstMedia?.whoWeArePara1 || "At Exegesis, we believe your spiritual journey deserves more than just a casual reading — it deserves a powerful, purpose-driven digital footprint rooted in faith and fueled by the Gospel."}
            </p>
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed font-medium mb-8">
              {t.himFirstMedia?.whoWeArePara2 || "We are a project of Him First Media Group, a full-service Christian digital marketing agency dedicated to helping Christian businesses, churches, and ministries shine online with excellence and integrity."}
            </p>
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed font-medium mb-12">
              {t.himFirstMedia?.whoWeArePara3 || "Our goal is simple: to help you reach more people, impact more lives, and glorify God through the power of His Word."}
            </p>
          </motion.div>
