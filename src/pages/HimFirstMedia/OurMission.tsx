        ...
        <div className="w-full max-w-4xl mx-auto text-center">
          <motion.div variants={animFadeUp} initial="hidden" animate="visible">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 mb-6">
              ...
              <span className="text-[10px] sm:text-xs font-black text-white/70 uppercase tracking-widest">Our Mission</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-medium">
              To help you reach more people, impact more lives, and glorify God through the power of His Word.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full max-w-4xl mx-auto">
          <motion.div variants={animFadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed font-medium mb-6">
              Our mission is simple: to make the deep truths of Scripture accessible to everyone, everywhere. We believe that the Word of God is alive, active, and relevant for every generation — and we're committed to using every tool at our disposal to help people engage with it.
            </p>
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed font-medium mb-12">
              As a project of Him First Media Group, we bring decades of experience in Christian digital marketing, app development, and web design to the service of the Church. We're not just building an app — we're building a movement of believers who are rooted in the Word and equipped for every good work.
            </p>
          </motion.div>
          ...
          <motion.div variants={animFadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid sm:grid-cols-2 gap-6 mt-12">
            {[
              { icon: BookOpen, title: "Teach the Word", desc: "Provide rich, verse-by-verse teaching that makes Scripture come alive." },
              { icon: Heart, title: "Build Community", desc: "Create a space where believers can pray, testify, and grow together." },
              { icon: Globe, title: "Reach the World", desc: "Make the Bible accessible in multiple languages and translations." },
              { icon: Zap, title: "Equip the Saints", desc: "Give believers the tools they need to study, journal, and apply God's Word." },
            ].map((v) => (
