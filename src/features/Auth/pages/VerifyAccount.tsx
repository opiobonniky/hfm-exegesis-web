// VerifyAccount — thin compositor using shared Auth components
        ...
        <div className="relative z-10 flex flex-col justify-between px-14 py-14 w-full">
          ...
          <div className="flex flex-col items-center text-center gap-8">
            ...
            <div>
              ...
              <p className="text-white/55 text-sm mt-2 tracking-wider">&mdash; {t.auth?.psalmReference || "Psalm 119:105"}</p>
            </div>
          </div>
