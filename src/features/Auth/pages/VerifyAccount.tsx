...
import { Mail, ArrowLeft, ArrowRight, Sparkles, KeyRound, CheckCircle } from "lucide-react";
import logoImage from "@/assets/logos/exegesis_bg_rm.png";
import { useVerifyAccountPage } from "../hooks/useVerifyAccountPage";

const VerifyAccount = () => {
  const p = useVerifyAccountPage();
  const { t, isRtl, email, setEmail, code, setCode, isLoading, isResending, success, error, handleVerify, handleResend } = p;
  return (
      {/* Left Panel */}
