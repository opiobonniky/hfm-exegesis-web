import { useLookStagePage } from "../hooks/useLookStagePage";
export default function LookStage(props: any) {
  const p = useLookStagePage(props);
  const { promptNotes, currentText, saved, expandedPrompts, setExpandedPrompts, switchPrompt, handleTextChange, handleSave, completedCount, allDone } = p;
  return (
            ...
            <div className="pt-3 border-t border-amber-200/30 dark:border-amber-800/20">
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={3}
                  className={cn(
                    "w-full rounded-lg border bg-card/80 text-foreground text-sm p-3 resize-none transition-all",
