import { BookOpen, X, ChevronLeft, ChevronRight, CheckCircle2, Layers, Timer, FileText, Sparkles } from "lucide-react";
...
export default function LabHomePage() {
  const p = useLabHome();
  const { navigate, activeSession, history, loading, showOnboarding, onboardingStep, setOnboardingStep, dismissOnboarding, handleResumeStudy, handleReviewStudy } = p;
            ...
            <div className="p-6 pt-8">
              ...
              <div className="flex flex-col items-center text-center">
                <div className={cn("w-16 h-16 rounded-2xl flex items-center justify-center mb-4 shadow-lg transition-all", ONBOARDING_STEPS[onboardingStep].bg)}>
                  <Sparkles className={cn("w-8 h-8", ONBOARDING_STEPS[onboardingStep].color)} />
                </div>
