...
// parseDate: safely parse a date string or object
...
export const fmtDate = (v: any, format: "short" | "long" = "short"): string => {
  try {
    return new Date(parseDate(v)).toLocaleDateString("en-US", {
      weekday: format, month: format, day: "numeric", year: "numeric",
    });
  } catch {
    return "";
  }
...
export const isToday = (v: any): boolean => {
    ...
    return false;
/** Parse a passage reference like "John 15:4-5" into structured data */
