    ...
    <FormCard title={t.journal?.linkToScripture || "Link to Scripture"} icon={BookOpen}>
      <div className="space-y-3">
        <div className="space-y-1.5">
          ...
          <Select value={testament} onValueChange={(v) => { setTestament(v); setEntry((prev) => ({ ...prev, bookName: "", chapter: "", verseNumber: "" })); }}>
          ...
          <Select value={entry.bookName} onValueChange={(v) => setEntry((prev) => ({ ...prev, bookName: v, chapter: "", verseNumber: "" }))} disabled={!testament}>
        ...
        {entry.bookName && chapters.length > 0 && (
          <>
            <div className="space-y-1.5">
              ...
              <Select value={entry.chapter} onValueChange={(v) => setEntry((prev) => ({ ...prev, chapter: v, verseNumber: "" }))}>
