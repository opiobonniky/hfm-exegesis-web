...
export default function HeroSection({ userName, initial, verse }: HeroSectionProps) {
  ...
  return (
    <div className="relative bg-gradient-to-br from-primary/5 via-background to-background overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-violet-500/[0.03] rounded-full blur-3xl translate-y-1/2 -translate-x-1/3" />
        ...
        {verse && (
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-bold tracking-[0.15em] uppercase text-white/40 mb-2">Verse of the day</p>
                <p className="text-base sm:text-lg font-semibold text-white/95 leading-relaxed line-clamp-2" style={{ fontFamily: "'Lora', Georgia, serif" }}>
