...
export default function PlanDetail() {
  ...
  return (
    <Gate
      tier="legacy_sower"
      featureName="Reading Plans"
      featureDescription="View reading plan details."
    >
      <PageLayout isRtl={data.isRtl} accentColor="primary">
        <PlanDetailHeader
          ...
          t={data.t}
          pct={data.pct}
          displayQuizAccuracy={data.displayQuizAccuracy}
          displayAnsweredQuestions={data.displayAnsweredQuestions}
          displayCorrectAnswers={data.displayCorrectAnswers}
          displayWrongAnswers={data.displayWrongAnswers}
          totalReflections={data.totalReflections}
          configuredDays={data.configuredDays}
          configuredPct={data.configuredPct}
        ...
        {data.activeTab === "admin" && data.isAdmin && (
          <PlanAdminTab
            ...
            setUserSearchFilter={actions.setUserSearchFilter}
            plan={data.plan}
            isRtl={data.isRtl}
            lang={data.lang}
            t={data.t}
        ...
        {data.activeTab === "schedule" && (
          <PlanScheduleTab
            ...
            days={data.days}
            completedDayNums={data.completedDayNums}
            questionsEnabled={data.plan.questions_enabled}
            totalDays={data.plan.total_days}
          />
        )}
        {data.activeTab === "quiz" && (
          <PlanQuizTab
